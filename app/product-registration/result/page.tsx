      ...
      <section className="px-4 py-8 sm:py-12">
        <div className="mx-auto w-full max-w-[760px]">
          ...
          <button
            ...
            className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-md border border-[#b3b3b6] px-5 text-base font-semibold text-[#191919] transition hover:bg-[#f7f7f8] sm:w-auto"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 20 20"
